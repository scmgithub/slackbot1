...
if($token != 'kE7PryItAWUBwKwzaj53gZfS'){ # from your slash command configuration page
...
$user_agent = "IsitupForSlack/1.0 (https://github.com/scmphub/slackbot1; scm.phub@gmail.com)";
